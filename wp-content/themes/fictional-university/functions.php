...
include_once('inc/like-route.php');
...
function university_files() {
    ...
    wp_enqueue_style('custom-google-fonts', '//fonts.googleapis.com/css?family=Roboto+Condensed:300,300i,400,400i,700,700i|Roboto:100,300,400,400i,700,700i', array(), null,  'all');
    wp_enqueue_style('font-awesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), '4.7.0',  'all');
    wp_enqueue_style('university_main_styles', get_theme_file_uri('/build/style-index.css'), array(), '1.0',  'all');
    wp_enqueue_style('university_extra_styles', get_theme_file_uri('/build/index.css'), array(), '1.0',  'all');
