...
class Search {
  ...
  constructor() {
    ...
    this.openBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-search-trigger");
  ...
  keyPressDispatcher(e) {
    ...
    if (e.keyCode == 27 && this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(":focus")) {
      this.closeOverlay();
    }
  }
  openOverlay() {
    ...
    setTimeout(() => jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.searchField).trigger("focus"), 301);
  }
  closeOverlay() {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkfictional_university"] = globalThis["webpackChunkfictional_university"] || [];
